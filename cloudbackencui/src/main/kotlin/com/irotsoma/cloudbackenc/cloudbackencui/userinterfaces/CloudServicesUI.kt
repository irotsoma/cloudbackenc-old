...
class CloudServicesUI() : Fragment() {
    ...
    fun setupCloudService(userId: String){
        ...
        val httpEntity = HttpEntity<CloudServiceUser>(CloudServiceUser(userId, null, availableCloudServicesModel.service.uuid.toString(), CloudServiceUser.STATE.INITIALIZED, callbackURL), requestHeaders)
